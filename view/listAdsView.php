        ...
        <div class = "sidebar-sticky">
            ...
            <ul class="nav flex-column">
                ...
                foreach ($operations as $operation) {
                    ?>
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo $helper->url("Ad", "listAds", array("type_operation" => $operation->name, "type_house" => $_house, "pag" => 0)); ?>">
            ...
            <ul class="nav flex-column">
                ...
                foreach ($houses as $house) {
                    ?>
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo $helper->url("Ad", "listAds", array("type_house" => $house->name, "type_operation" => $_operation, "pag" => 0)); ?>">
